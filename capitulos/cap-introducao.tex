...
\textcolor{red}{Já acrescentei todas as referências da tese no arquivo main.bib.}

Visão geral de onde a sua pesquisa de TCC está inserida.

De acordo com \citet{kossoski2024mdpinopquery}, o NOP Query resolve um problema do custo computacional.

% \cite: para citações no final da frase.
% \citet: para citações no início ou meio de frase.
